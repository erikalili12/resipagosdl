    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <form action="<?php echo e(route('index')); ?>" method="get" class="search-form">
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo e(route('residentes.create')); ?>" class="btn btn-success">Nuevo Residentee</a>
...
<?php /**PATH C:\xampp\htdocs\17-01-24  4\loginmoderno14\resources\views/residentes/index.blade.php ENDPATH**/ ?>