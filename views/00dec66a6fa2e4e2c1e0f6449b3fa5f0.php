        ...
        <div class="col-md-6 mx-auto">
            ...
            <form action="<?php echo e(route('residentes.index')); ?>" method="get" class="search-form">
                ...
                <div class="form-group">
                    ...
                    <input type="texto" class="form-control" name="texto" value="<?php echo e($texto); ?>">
                </div>
                <div class="form-group">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\loginmoderno11\resources\views/home.blade.php ENDPATH**/ ?>