...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <form action="{{ route('residentes.index') }}" method="get" class="search-form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-success">Cerrar Sesión</a>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('residentes.imprimir', $residentes[0]->id_resident) }}" class="btn btn-info">Imprimir Residente</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <a href="{{ route('aviso.legal') }}">Aviso de legal</a>
